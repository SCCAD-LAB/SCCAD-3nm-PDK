...
- Dual-side BEOL support – Enables backside routing for power, clock, and signals. Our standard cells for backside power delivery networks (BS-PDN) integrate buried power rails (BPR) to improve routing efficiency and power integrity.
...
OpenPiton placement <br>using our 3nm PDK and OpenROAD EDA
    </td>
    <td align="center">
  <img src="Sample%20Designs/openpiton-route.png" width="300"><br>
OpenPiton routing <br>using our 3nm PDK and OpenROAD EDA
    </td>
  </tr>
</table>
</div>
...
| --- | --- | --- | --- | --- |
| Cadence  | ECG | [README](PnR-Cadence/Front-side%20Version/Runfiles/README.md) | [ECG_innovus.run.sh](PnR-Cadence/Front-side%20Version/Runfiles/ECG_innovus.run.sh) | [ECG](Sample%20Designs/PnR%20Sample-Cadence/ecg) |
|   | OpenPiton | [README](PnR-Cadence/Front-side%20Version/Runfiles/README.md) | [OpenPiton_innovus.run.sh](PnR-Cadence/Front-side%20Version/Runfiles/OpenPiton_innovus.run.sh) | [OpenPiton](Sample%20Designs/PnR%20Sample-Cadence/openpiton) |
| Synopsys |ECG | [README](PnR-Synopsys/Front-side%20Version/Runfiles/README.md) | [ECG_icc2.run.sh](PnR-Synopsys/Front-side%20Version/Runfiles/ECG_icc2.run.sh) | [ECG](Sample%20Designs/PnR%20Sample-Synopsys/ecg) |
|  | OpenPiton | [README](PnR-Synopsys/Front-side%20Version/Runfiles/README.md)| [OpenPiton_icc2.run.sh](PnR-Synopsys/Front-side%20Version/Runfiles/OpenPiton_icc2.run.sh)  | [OpenPiton](Sample%20Designs/PnR%20Sample-Synopsys/openpiton) |
| OpenROAD | ECG | [README](PnR-OpenROAD/Front-side%20Version/OpenROAD_Runfiles/README.md) | [run_openroad.sh](PnR-OpenROAD/Front-side%20Version/OpenROAD_Runfiles/run_openroad.sh); configure [3nm_run.tcl](PnR-OpenROAD/Front-side%20Version/OpenROAD_Runfiles/3nm_run.tcl) to [ecg.tcl](PnR-OpenROAD/Front-side%20Version/OpenROAD_Runfiles/design_configs/ecg.tcl)  |[ECG](Sample%20Designs/PnR%20Sample-OpenROAD/ecg) |
|  | OpenPiton | [README](PnR-OpenROAD/Front-side%20Version/OpenROAD_Runfiles/README.md)| [run_openroad.sh](PnR-OpenROAD/Front-side%20Version/OpenROAD_Runfiles/run_openroad.sh); configure [3nm_run.tcl](PnR-OpenROAD/Front-side%20Version/OpenROAD_Runfiles/3nm_run.tcl) to [openpiton.tcl](PnR-OpenROAD/Front-side%20Version/OpenROAD_Runfiles/design_configs/openpiton.tcl)  | [OpenPiton](Sample%20Designs/PnR%20Sample-OpenROAD/openpiton) |
