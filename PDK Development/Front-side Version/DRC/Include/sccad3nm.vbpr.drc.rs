...
rVBPR_2 @= { @ "VBPR.2 : HORIZONTAL width of VBPR = 12 nm";
        gVBPR2_check = internal1( aVBPR, == 0.012, extension = NONE, direction = HORIZONTAL);
...
rVBPR_4 @= { @ "VBPR.4 : VBPR may not lie outside SDCON";
        not_inside( aVBPR, aSDT, include_touch = ALL);
}
